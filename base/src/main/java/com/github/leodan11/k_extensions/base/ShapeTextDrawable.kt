 ...
 *
 * @constructor Creates an empty ShapeTextDrawable.
 *
 * ```
 *
 * imageView.apply {
 *     val drawable = ShapeTextDrawable.build("A", Color.RED)
 *     setImageDrawable(drawable)
 * }
 *
 * ```
 *
 * @param builder [Builder] default [Unit]
 *
 *
 */
@Suppress("unused")
open class ShapeTextDrawable private constructor(builder: Builder) : ShapeDrawable(builder.shape) {
    ...
    init {
        ...
        // text and color
        text =
            if (builder.toUpperCase) builder.text.orEmpty().uppercase(Locale.ROOT)
            else builder.text
        color = builder.color
    ...
    class Builder {
        ...
        fun buildRect(text: String, @ColorInt color: Int): ShapeTextDrawable {
            rect()
            return build(text, color)
        }

        fun buildRoundRect(text: String, @ColorInt color: Int, radius: Int): ShapeTextDrawable {
            roundRect(radius)
            return build(text, color)
        }

        fun buildRound(text: String, @ColorInt color: Int): ShapeTextDrawable {
            round()
            return build(text, color)
        }

        fun build(text: String, @ColorInt color: Int): ShapeTextDrawable {
            this.color = color
            this.text = text
            return ShapeTextDrawable(this)
        }

        fun buildRect(drawable: Drawable, @ColorInt color: Int): ShapeTextDrawable {
            rect()
        ...
        fun buildRound(drawable: Drawable, @ColorInt color: Int): ShapeTextDrawable {
            round()
            return build(drawable, color)
        }

        fun build(drawable: Drawable, @ColorInt color: Int): ShapeTextDrawable {
            this.color = color
